...
const initTestimonials = () => {
	...
	const dots = Array.from(
		document.querySelectorAll<HTMLSpanElement>(".testimonial-dots span"),
	);
...
const setupPartnerTabs = () => {
	...
	const showBenefitTab = () => {
		...
		tabBenefit.classList.remove(
			"bg-white/60",
			"text-text-muted",
			"border-primary/10",
		);
		tabCara.classList.add(
			"bg-white/60",
			"text-text-muted",
			"border-primary/10",
		);
	...
	const showCaraTab = () => {
		...
		tabCara.classList.remove(
			"bg-white/60",
			"text-text-muted",
			"border-primary/10",
		);
		tabBenefit.classList.add(
			"bg-white/60",
			"text-text-muted",
			"border-primary/10",
		);
