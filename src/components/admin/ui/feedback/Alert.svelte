...
<div class="flex items-start gap-3 p-4 {alertConfig.bg} border {alertConfig.border} rounded-2xl {alertConfig.text} {className}" {...rest}>
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="{alertConfig.iconColor} shrink-0 mt-0.5">
