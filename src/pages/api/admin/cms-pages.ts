...
export async function POST(ctx: APIContext) {
    ...
    const title = sanitizeText(String((body as any).title || ""));
    const slug = sanitizeText(String((body as any).slug || ""));
    const content = String((body as any).content_md || "");
    const isActive = String((body as any).is_active || "true") === "true";
