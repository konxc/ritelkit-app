...
export async function POST(ctx: APIContext) {
    ...
    const status = sanitizeText(String((body as any).status || "packing"));
    const carrier = sanitizeText(String((body as any).carrier || ""));
    const trackingNo = sanitizeText(String((body as any).tracking_no || ""));
